 ...
 * @property {{
 *   baseColor: string,                   // hex like "#ffffff"
 *   activeBaseLayer: BaseLayer,          // mirrors your app
 *   textureSlots: {
 *     base?: TextureRef,                 // default/base layer
 *     upload?: TextureRef,               // user-uploaded
 *     camera?: TextureRef,               // captured from camera
 *     textOverlay?: string               // optional text layer you compose
 *   }
 * }} appearance
 */
 ...
 * @param {Partial<Vase> & { id: string }} init - Provide at least an id, override any field as needed.
 * @returns {Vase}
 */
